...
<form name="myForm" method="post" class="form-signin" action="">
  ...
  <button class="btn btn-lg btn-primary btn-block"  style="background-color: rgb(251, 104, 104);font-family:Georgia, 'Times New Roman', Times, serif;"type="submit" name="valider">Se Connecter</button>
