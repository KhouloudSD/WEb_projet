...
<button type="button"  style="background-color: rgb(251, 104, 104); font-family:Georgia, 'Times New Roman', Times, serif" onclick="rechercher()" class="btn btn-primary btn-block active" > selectioner</button>
</form>
</div>  
</main>
